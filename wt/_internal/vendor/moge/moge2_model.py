...
import structlog
import torch
from wt._internal.vendor.moge import utils3d
from wt._internal.vendor.moge.dinov2.vision_transformer import DinoVisionTransformer
from wt._internal.vendor.moge.utils.geometry_torch import (
    normalized_view_plane_uv,
    recover_focal_shift,
)
from wt._internal.vendor.moge.utils.wrap_module import wrap_dinov2_attention_with_sdpa
from torch import nn
from torch.nn import functional as F

from wt._internal import wfile, wpath
...
class DINOv2Encoder(nn.Module):
    ...
    def __init__(
        ...
        **deprecated_kwargs,
        ...
        # Load the backbone
        from wt._internal.vendor.moge.dinov2 import hub
